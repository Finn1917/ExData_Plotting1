...
## Make first graph
##
with(finTab,plot(flDate, Global_active_power, xlab = "", ylab = "Global Active Power", type = "n"))
with(finTab,lines(flDate, Global_active_power, type = "l"))
##
## Make second graph
##
with(finTab, plot(flDate, Voltage, type = "l", xlab = "datetime"))
##
## Make third graph
...
##
## Make fourth grpah
with(finTab, plot(flDate, Global_reactive_power, type = "l", xlab = "datetime"))
##
dev.off()
